...
export const PIN_PLACE_REQUEST = 'PIN_PLACE_REQUEST';
export const PIN_PLACE_SUCCESS = 'PIN_PLACE_SUCCESS';
export const PIN_PLACE_FAILURE = 'PIN_PLACE_FAILURE';

export const UNPIN_PLACE_REQUEST = 'UNPIN_PLACE_REQUEST';
export const UNPIN_PLACE_SUCCESS = 'UNPIN_PLACE_SUCCESS';
export const UNPIN_PLACE_FAILURE = 'UNPIN_PLACE_FAILURE';

export const FETCH_PINNED_PLACES_REQUEST = 'FETCH_PINNED_PLACES_REQUEST';
export const FETCH_PINNED_PLACES_SUCCESS = 'FETCH_PINNED_PLACES_SUCCESS';
export const FETCH_PINNED_PLACES_FAILURE = 'FETCH_PINNED_PLACES_FAILURE';
...
export const ADD_BACKGROUND_IMAGE_REQUEST = 'ADD_BACKGROUND_IMAGE_REQUEST';
export const ADD_BACKGROUND_IMAGE_SUCCESS = 'ADD_BACKGROUND_IMAGE_SUCCESS';
export const ADD_BACKGROUND_IMAGE_FAILURE = 'ADD_BACKGROUND_IMAGE_FAILURE';
...
export const CONNECT_USERS_FAILURE = 'CONNECT_USERS_FAILURE';

export const REMOVE_FROM_SUGGESTIONS_REQUEST = 'REMOVE_FROM_SUGGESTIONS_REQUEST';
export const REMOVE_FROM_SUGGESTIONS_SUCCESS = 'REMOVE_FROM_SUGGESTIONS_SUCCESS';
export const REMOVE_FROM_SUGGESTIONS_FAILURE = 'REMOVE_FROM_SUGGESTIONS_FAILURE';
